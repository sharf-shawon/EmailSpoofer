...
echo '<html>';
echo "<head><title>Sent email records!</title></head>";
echo '<link rel="stylesheet" href="bootstrap-4.0.0/css/bootstrap.min.css">';
echo '<link rel="stylesheet" href="style.css">';
echo "<body style='background-image: url(\'img/bg.png\');'><div class='container-fluid pt-5'><div class='col-12'>";
echo '<h1 class="text-center">Email Records</h1>';
echo '<p class="text-right"><a class="text-danger" href="./?logout">Logout</a></p>';
...
echo '<tr><td colspan=255 align=center><a class="btn btn-danger text-white" href="./" >Go Back</a></td></tr>';
echo '</table>';
echo "</form></div></div>
